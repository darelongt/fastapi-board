...
from backend.answer import answer_schema, answer_crud
from backend.question import question_crud
...
# @router.get("/sex")
# def read_root(dep: str = Depends()):
#     print("depdepdepdepdepdepdepdep'%")
#     print(dep)
#     print("depdepdepdepdepdepdepdep'%")
