...
from backend.question import question_schema, question_crud
from backend.user.user_router import get_current_user
...
#                     db: Session = Depends(get_db),
#                     current_user: User = Depends(get_current_user)):
#     question_crud.update_question(db=db, question_update=_question_update, user=current_user)
